...
internal sealed partial class ScheduleCleanupWorker(
    IServiceScopeFactory scopes,
    TimeProvider time,
    IOptions<SchedulingOptions> options,
    ILogger<ScheduleCleanupWorker> logger)
    : BackgroundService
{
    ...
    [LoggerMessage(
        ...
        Level = LogLevel.Warning,
        Message =
            "Scheduled message cleanup reached the per-run cap of {MaxBatchesPerRun} batches at {BatchSize} items per batch; additional cleanup will wait for the next interval.")]
